...
$(document).ready(function() {
	...
	$("#submitBrandForm").unbind('submit').bind('submit', function() {
		...
		if(brandStatus == "") {
			$("#brandStatus").after('<p class="text-danger">"Veuillez entrer un statut"</p>');
		...
		$.ajax({
			...
			success:function(response) {
				...
				$('#editBrandForm').unbind('submit').bind('submit', function() {
					...
					if(brandStatus == "") {
						$("#editBrandStatus").after('<p class="text-danger">"Veuillez entrer une marque"</p>');
		...
		$.ajax({
			...
			success:function(response) {
				...
				$("#removeBrandBtn").unbind('click').bind('click', function() {
					...
					$("#removeBrandBtn").button('chargement');
