$(document).ready(function() {
	...
	$("#changeUsernameForm").unbind('submit').bind('submit', function() {
		...
		if(username == "") {
			$("#username").after('<p class="text-danger">Veuillez insérer un nom</p>');
	...
	$("#changePasswordForm").unbind('submit').bind('submit', function() {
		...
		if(currentPassword == "" || newPassword == "" || conformPassword == "") {
			if(currentPassword == "") {
				$("#password").after('<p class="text-danger">Veuillez insérer un mot de passe</p>');
			...
			if(newPassword == "") {
				$("#npassword").after('<p class="text-danger">Veuillez insérer votre nouveau mot de passe</p>');
			...
			if(conformPassword == "") {
				$("#cpassword").after('<p class="text-danger">Veuillez insérer votre nouveau mot de passe</p>');
