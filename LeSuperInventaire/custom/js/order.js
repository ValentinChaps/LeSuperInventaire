...
$(document).ready(function() {
	...
	if(divRequest == 'add')  {
		...
		$("#createOrderForm").unbind('submit').bind('submit', function() {
			...
			if(orderDate == "") {
				$("#orderDate").after('<p class="text-danger"> La date de la commande est nécessaire </p>');
			...
			if(clientName == "") {
				$("#clientName").after('<p class="text-danger"> Le nom du client est nécessaire </p>');
			...
			if(clientContact == "") {
				$("#clientContact").after('<p class="text-danger"> Le téléphone du client est nécessaire </p>');
			...
			if(paid == "") {
				$("#paid").after('<p class="text-danger"> Veuillez insérer le montant payé </p>');
			...
			if(discount == "") {
				$("#discount").after('<p class="text-danger"> Veuillez insérer une réduction </p>');
			...
			if(paymentType == "") {
				$("#paymentType").after('<p class="text-danger"> Veuillez insérer le type de paiement </p>');
			...
			if(paymentStatus == "") {
				$("#paymentStatus").after('<p class="text-danger"> Veuillez insérer le statut du paiement </p>');
		    ...
		    if(productName[x].value == ''){	    		    	
		    	$("#"+productNameId+"").after('<p class="text-danger"> Le nom du produit est nécessaire </p>');
	   	...
	   	for (var x = 0; x < quantity.length; x++) {       
		    ...
		    if(quantity[x].value == ''){	    	
		    	$("#"+quantityId+"").after('<p class="text-danger"> Veuillez insérer une quantité </p>');
		...
		$("#editOrderForm").unbind('submit').bind('submit', function() {
			...
			if(orderDate == "") {
				$("#orderDate").after('<p class="text-danger"> Veuillez insérer la date du paiement </p>');
				$('#orderDate').closest('.form-group').addClass('has-error');
			} else {
				$('#orderDate').closest('.form-group').addClass('has-success');
			} 
			...
			if(clientName == "") {
				$("#clientName").after('<p class="text-danger"> Veuillez insérer le nom du client </p>');
				$('#clientName').closest('.form-group').addClass('has-error');
			} else {
				$('#clientName').closest('.form-group').addClass('has-success');
			} 
			...
			if(clientContact == "") {
				$("#clientContact").after('<p class="text-danger"> Veuillez insérer le téléphone du client </p>');
				$('#clientContact').closest('.form-group').addClass('has-error');
			} else {
				$('#clientContact').closest('.form-group').addClass('has-success');
			} 
		...
		$.ajax({
			...
			success:function(response) {				
				...
				$("#updatePaymentOrderBtn").unbind('click').bind('click', function() {
					...
					if(payAmount == "") {
						$("#payAmount").after('<p class="text-danger">Veuillez insérer le montant a payé</p>');
